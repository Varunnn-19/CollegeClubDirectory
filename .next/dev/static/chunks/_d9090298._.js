...
function Hero3DScene() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Hero3DScene.useEffect": ()=>{
            if (!mountRef.current || ("TURBOPACK compile-time value", "object") === "undefined") return;
            try {
                // Scene setup
                ...
                const camera = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PerspectiveCamera"](75, width / height, 0.1, 1000);
                camera.position.z = 5;
                ...
                const handleResize = {
                    "Hero3DScene.useEffect.handleResize": ()=>{
                        ...
                        }["Hero3DScene.useEffect.handleResize"], 100);
                    }
                }["Hero3DScene.useEffect.handleResize"];
                if ("TURBOPACK compile-time truthy", 1) {
                    ...
                    "Hero3DScene.useEffect.cleanup": ()=>{
                        ...
                        if (sceneRef.current) {
                            sceneRef.current.traverse({
                                "Hero3DScene.useEffect.cleanup": (object)=>{
                                    if (object instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"]) {
                                        ...
                                        if (Array.isArray(object.material)) {
                                            object.material.forEach({
                                                "Hero3DScene.useEffect.cleanup": (mat)=>mat.dispose()
                                            }["Hero3DScene.useEffect.cleanup"]);
                                        } else {
                ...
                setIsLoaded(false);
                return ({
                    "Hero3DScene.useEffect": ()=>{} // Return empty cleanup on error
                })["Hero3DScene.useEffect"];
            }
        }
    }["Hero3DScene.useEffect"], []);
...
"[project]/components/loading-3d.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Loading3D({ onComplete }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Loading3D.useEffect": ()=>{
            ...
            try {
                const scene = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Scene"]();
                const camera = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PerspectiveCamera"](75, 200 / 200, 0.1, 1000);
                const renderer = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WebGLRenderer"]({
                    antialias: true,
                    alpha: true
                });
                ...
                const geometries = [
                    new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BoxGeometry"](1, 1, 1),
                    new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SphereGeometry"](0.7, 16, 16),
                    new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OctahedronGeometry"](0.7),
                    new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TetrahedronGeometry"](0.7)
                ];
                const material = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
                    color: 0x9fdcc8,
                    metalness: 0.7,
                ...
                const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](geometries[0], material);
                scene.add(mesh);
                const light = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointLight"](0x9fdcc8, 1, 100);
                ...
                return ({
                    "Loading3D.useEffect": ()=>{
                        ...
                        geometries.forEach({
                            "Loading3D.useEffect": (geo)=>geo.dispose()
                        }["Loading3D.useEffect"]);
                        material.dispose();
                        if (renderer) {
                            renderer.dispose();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/components/loading-3d.jsx",
            lineNumber: 96,
            columnNumber: 7
        }, this)
    }, void 0, false, {
...
_s(Loading3D, "7ZxWfzlhKD8OrHjuJ/lgGu7UCHg=");
_c = Loading3D;
var _c;
__turbopack_context__.k.register(_c, "Loading3D");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$loading$2d$3d$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/loading-3d.jsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function LandingPage() {
    ...
    if (!isClient) return null;
    if (isLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$loading$2d$3d$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Loading3D"], {
...
_s(LandingPage, "dt9moghjzNmXMCCresIf4lEjlTo=");
_c = LandingPage;
var _c;
...
//# sourceMappingURL=_d9090298._.js.map