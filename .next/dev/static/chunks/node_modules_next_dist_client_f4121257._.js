...
const version = "16.0.2-canary.31";
window.next = {
    version,
    appDir: true
};
...
const isOutputExportMode = ("TURBOPACK simplified expression", ("TURBOPACK compile-time value", "development") === 'production');
        ...
        if (triggeredStatus) {
            ...
            return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
                children: [
                    ...
                    ("TURBOPACK simplified expression", /*#__PURE__*/ (0, _jsxruntime.jsx)("meta", {
...
const hmrRefreshReducer = ("TURBOPACK compile-time value", "development") === 'production' ? hmrRefreshReducerNoop : hmrRefreshReducerImpl;
if ((typeof exports.default === 'function' || typeof exports.default === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
    });
...
function ServerRoot({ initialRSCPayload, actionQueue, webSocket, staticIndicatorState }) {
    ...
    if ("TURBOPACK simplified expression", initialRSCPayload.m) {
