...
function createServerModuleMap({ serverActionsManifest }) {
    return new Proxy({}, {
        get: (_, id)=>{
            ...
            const workers = (_serverActionsManifest_ = serverActionsManifest[("TURBOPACK compile-time value", "nodejs") === 'edge' ? 'edge' : 'node']) == null ? void 0 : (_serverActionsManifest__id = _serverActionsManifest_[id]) == null ? void 0 : _serverActionsManifest__id.workers;
            if (!workers) {
                return undefined;
            }
            const workStore = __TURBOPACK__imported__module__$5b$externals$5d2f$next$2f$dist$2f$server$2f$app$2d$render$2f$work$2d$async$2d$storage$2e$external$2e$js__$5b$external$5d$__$28$next$2f$dist$2f$server$2f$app$2d$render$2f$work$2d$async$2d$storage$2e$external$2e$js$2c$__cjs$29$__["workAsyncStorage"].getStore();
...
function selectWorkerForForwarding(actionId, pageName, serverActionsManifest) {
    ...
    const workers = (_serverActionsManifest__actionId = serverActionsManifest[("TURBOPACK compile-time value", "nodejs") === 'edge' ? 'edge' : 'node'][actionId]) == null ? void 0 : _serverActionsManifest__actionId.workers;
...
const __TURBOPACK__loading__$23$1__ = ()=>__turbopack_context__.r("[project]/app/loading.jsx [app-rsc] (ecmascript, Next.js Server Component)");
...
const __TURBOPACK__page__$23$6__ = ()=>__turbopack_context__.r("[project]/app/clubs/[slug]/page.jsx [app-rsc] (ecmascript, Next.js Server Component)");
;
;
;
;
                        ...
                        "children": [
                            ...
                            {},
                            {
                                ...
                                "page": [
                                    ...
                                    "[project]/app/clubs/[slug]/page.jsx"
                                ]
                            }
                        ]
                    },
...
async function handler(req, res, ctx) {
    ...
    const isMinimalMode = Boolean(("TURBOPACK simplified expression", (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2d$meta$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getRequestMeta"])(req, 'minimalMode')));
   ...
   */ const couldSupportPPR = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$lib$2f$experimental$2f$ppr$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkIsAppPPREnabled"])(nextConfig.experimental.ppr);
    ...
    const hasDebugStaticShellQuery = ("TURBOPACK simplified expression", ("TURBOPACK compile-time value", false) === '1') && couldSupportPPR;
    // When enabled, this will allow the use of the `?__nextppronly` query
    // to enable debugging of the fallback shell.
    const hasDebugFallbackShellQuery = ("TURBOPACK simplified expression", hasDebugStaticShellQuery);
    // This page supports PPR if it is marked as being `PARTIALLY_STATIC` in the
    // prerender manifest and this is an app page.
    const isRoutePPREnabled = couldSupportPPR && (((_this = prerenderManifest.routes[normalizedSrcPage] ?? prerenderManifest.dynamicRoutes[normalizedSrcPage]) == null ? void 0 : _this.renderingMode) === 'PARTIALLY_STATIC' || ("TURBOPACK simplified expression", // Ideally we'd want to check the appConfig to see if this page has PPR
...
//# sourceMappingURL=node_modules_next_dist_8f820df7._.js.map