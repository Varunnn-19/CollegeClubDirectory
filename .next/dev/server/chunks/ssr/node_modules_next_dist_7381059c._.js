...
class NextRequestAdapter {
    static fromBaseNextRequest(request, signal) {
        ...
        ;
        else if ("TURBOPACK simplified expression", (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$base$2d$http$2f$helpers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isNodeNextRequest"])(request)) {
         ...
         */ const hasNoExplicitCacheConfig = pageFetchCacheMode == undefined && // eslint-disable-next-line eqeqeq
            ...
            if (hasNoExplicitCacheConfig && workUnitStore !== undefined) {
                switch(workUnitStore.type){
                    ...
                    case 'request':
                        if ("TURBOPACK simplified expression", workUnitStore.stagedRendering) {
                            if (cacheSignal) {
                                cacheSignal.endRead();
                                cacheSignal = null;
                            }
                ...
                return originFetch(input, clonedInit).then(async (res)=>{
                    ...
                    if (res.status === 200 && incrementalCache && cacheKey && (isCacheableRevalidate || serverComponentsHmrCache)) {
                        ...
                        switch(workUnitStore == null ? void 0 : workUnitStore.type){
                            ...
                            case 'request':
                                if (("TURBOPACK simplified expression", workUnitStore.stagedRendering) && workUnitStore.cacheSignal) {
            ...
            if ((workStore.isStaticGeneration || ("TURBOPACK simplified expression", ("TURBOPACK simplified expression", false) && workUnitStore)) && init && typeof init === 'object') {
                const { cache } = init;
