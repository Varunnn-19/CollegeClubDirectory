...
export const getClubs = async () => {
  try {
    ...
    console.warn("[data-utils] Falling back to static clubs dataset", error)
    return staticClubs
  }
}
...
export const getClubDetail = async (slug) => {
  ...
  try {
    ...
    if (fallbackClub) {
      console.warn("[data-utils] Using static club detail fallback for", slug)
      return {
        club: fallbackClub,
        stats: {
          memberCount: 0,
